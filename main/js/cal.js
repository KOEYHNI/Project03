document.addEventListener("DOMContentLoaded", function() {
    ...
    function buildCalendar() {
        ...
        for(let day = 1 - doMonth.getDay(); daysLength >= day; day++) {
            ...
            if(Math.sign(day) == 1 && lastDate.getDate() >= day) {
                ...
                // @param 일요일인 경우
                if(dom % 7 == 1) {
                    column.style.color = "#eb3b3e";
                }

                // @param 토요일인 경우
                if(dom % 7 == 0) {
                    column.style.color = "#2150c7";
            ...
            if(today.getFullYear() == date.getFullYear()) {
                ...
                if(today.getMonth() == date.getMonth()) {
                    ...
                    // @details 현재일인 경우
                    if(date.getDate() == day) {
                        column.style.backgroundColor = "#516c97";
                        column.style.color = "#ffffff";
                        column.style.borderRadius = '50em';
                        column.style.cursor = "pointer";
                        column.onclick = function(){ calendarChoiceDay(this); }
                    }
    ...
    function calendarChoiceDay(column) {
        ...
        if(document.getElementsByClassName("choiceDay")[0]) {
            ...
            document.getElementsByClassName("choiceDay")[0].style.color = "#444444";
