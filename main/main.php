...
?>							
								<div class="login_box">
									<div class="login_img">
										<img src="images/login_icon01.png" alt="로그인을 해주세요"/>
									</div>
									<div class="login_top">
...
?>
							<div class="login_box">
								<div class="login_img">
									<img src="images/member.png" alt="로그인을 해주세요"/>
								</div>
								<p class="member">
								...
								<div class="button_lg">
									...
									<span><a href="../login/mamber_modify_form.php">정보수정</a></span> 
<?php 
	if($userlevel==1){
?>
...
?>							
						...
						<div class="animation_canvas">
							<div class="slider_panel">
								<img src="images/bn43.jpg" class="slider_img" style="left: 0;"alt="메인베너1"/>
								<img src="images/bn2.jpg" class="slider_img" alt="메인베너2"/>
								<img src="images/bn3.jpg" class="slider_img" alt="메인베너3"/>
								<!-- <img src="images/bn4.jpg" class="slider_img" alt="메인베너4"/> -->
								<img src="images/bn5.jpg" class="slider_img" alt="메인베너5"/>
								<img src="images/bn6.jpg" class="slider_img" alt="메인베너6"/>
								<!-- <img src="images/bn7.jpg" class="slider_img" alt="메인베너7"/> -->
								<img src="images/bn8.jpg" class="slider_img" alt="메인베너8"/> 
								<!-- <img src="images/bn9.jpg" class="slider_img" alt="메인베너9"/> -->
							</div>   
							<div class="ar_pannel">
								<span class="left"><a href="#" onclick="return true"><img src="images/ar_left.png" alt="이전"/ width="50"></a></span>
								<span class="right"><a href="#" onclick="return true"><img src="images/ar_right.png" alt="다음"width="50"/></a></span>
							</div>
						...
						<div id="end_right">
							<div class="book_banner">
								<div class="bookList">
									<ul>
										<li class="slideshow">
											<a href="../sub6/sub6.php"><span><img src="images/book11.jpg" width="147" height="206" alt="book1" class="frame"/><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book12.jpg" width="147" height="206" alt="book1" class="frame"/><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book13.jpg" width="147" height="206" alt="book1" class="frame"/><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book14.jpg"width="147" height="206" alt="book1" class="frame"/><span class="hit"></span></span></a>
										</li>
										<li class="slideshow second">
											<a href="../sub6/sub6.php"><span><img src="images/book15.jpg" width="147" height="206" alt="book2" class="frame"/><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book16.jpg" width="147" height="206" alt="book2" class="frame"/><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book17.gif" width="147" height="206" alt="book2" class="frame"/><span class="hit"></span></span></a>
										</li>
										<li class="slideshow last">
											<a href="../sub6/sub6.php"><span><img src="images/book18.jpg" width="147" height="206" alt="book3" /><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book19.jpg" width="147" height="206" alt="book3" /><span class="hit"></span></span></a>
											<a href="../sub6/sub6.php" class="alt"><span><img src="images/book20.jpg" width="147" height="206" alt="book3" /><span class="hit"></span></span></a>
										</li>
									</ul>
							...
							<div id="promotion_wrap" class=" cf">
								<div class="promo_box1 cf">
									<div class="promo_box1_theme cf">
										...
										<a href="#"><img src="images/bn3.jpg" width="280" height="280" alt="문화행사 썸네일이미지"/></a>
										<p class="promo_box_bar cf">문화행사 더보기</p>
										<div class="promo_box1_contentsImg cf">
											<div class="promo_box1_content1 fl">
												<a href="#"><img src="images/ob2.jpg" width="280" height="280" alt="문화행사 서브1"/></a>
												<p>『학창시절하면 어떤 게 떠오르세요?』</p>
											</div>
											<div class="promo_box1_content2 fl">
												<a href="#"><img src="images/ob3.jpg" width="280" height="280" alt="문화행사 서브1"/></a>
												<p>『이럴 땐 어떻게 해야 할까요?』</p>
											</div>
											<div class="promo_box1_content3 fl">
												<a href="#"><img src="images/ob4.jpg" width="280" height="280" alt="문화행사 서브1"/></a>
								...
								<div class="promo_box2 cf">
									<div class="promo_box2_theme cf">
										...
										<a href="https://www.instagram.com/p/CUwEY7SBhaX/"target="_blank"><img src="images/igb2.jpg" width="280" height="280" alt="Instagram 썸네일이미지"/></a>
										<p class="promo_box_bar cf">Instagram 더보기</p>
									</div>
									<div class="promo_box2_contentsImg cf">
										<div class="promo_box2_content1 fl">
											<a href="
											https://www.instagram.com/p/CUpBmIWhcM4/" target="_blank"><img src="images/igb1.jpg" width="280" height="280" alt="Instagram 사진1"/>
											</a>
											<p>자연밥상 뽐내기 이벤트</p>
										</div>
										<div class="promo_box2_content2 fl">
											<a href="https://www.instagram.com/p/CUq026JhLL-/" target="_blank"><img src="images/igb3.jpg" width="280" height="280" alt="Instagram 사진1"/>
											</a>
											<p>마음을 울리는 오늘의 시 한 편</p>
										</div>
										<div class="promo_box2_content3 fl">
											<a href="https://www.instagram.com/p/CUtTRZMhGzZ/" target="_blank"><img src="images/igb4.jpg" width="280" height="280" alt="Instagram 사진1"/></a>
											<p>&lt;요즘 아이들 마음고생의 비밀&gt;</p>
										</div>
									</div>
								</div>
										...
										<div class="promo_box4_content1 fl">
											<div class="calendar">
												<table class="scriptCalendar">
													<thead>
														<tr>
															<td colspan="2"onClick="prev();" style="cursor:pointer;"class="arrow"><img src="images/day_pre.png" alt="prev"/></td>
															<td colspan="3" class="m_title">
																<span id="calYear">YYYY</span>년
																<span id="calMonth">MM</span>월
															</td>
															<td colspan="2" onClick="next();" style="cursor:pointer;"class="arrow"><img src="images/day_next.png" alt="next"/></td>
														</tr>
														<tr class="day_title">
					...
					<div id="end_banner">
						<div class="banner_box">
							<span class="f_left"><a href="#" onclick="return true"><img src="images/ar_left.png" alt="이전"/ width="50"></a></span>
							
							<span class="f_right"><a href="#" onclick="return true"><img src="images/ar_right.png" alt="다음"/ width="50"></a></span>
							<div id="f_banner_box">
								<ul>
									<li class="thumb"><a href="#"><img src="images/end_banner1.jpg" alt="하단배너1"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner2.jpg" alt="하단배너2"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner3.jpg" alt="하단배너3"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner4.jpg" alt="하단배너4"/></a></li>
									<li class="thumb"><a href="#"><img src="images/end_banner5.jpg" alt="하단배너5"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner6.jpg" alt="하단배너6"/></a></li>
									<li class="thumb m8"><a href="#"><img src="images/end_banner7.jpg" alt="하단배너7"/></a></li>
									<li class="thumb m8"><a href="#"><img src="images/end_banner8.jpg" alt="하단배너8"/></a></li>
									<li class="thumb m6"><a href="#"><img src="images/end_banner9.jpg"  alt="하단배너9"/></a></li>
									<li class="thumb"><a href="#"><img src="images/end_banner10.png" alt="하단배너10"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner11.jpg" alt="하단배너11"/></a></li>
									<li class="thumb m15"><a href="#"><img src="images/end_banner12.jpg" class="m10" alt="하단배너12"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner13.png" alt="하단배너13"/></a></li>
									<li class="thumb"><a href="#"><img src="images/end_banner14.jpg" alt="하단배너14"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner15.jpg" alt="하단배너15"/></a></li>
									<li class="thumb m5"><a href="#"><img src="images/end_banner16.jpg" alt="하단배너16"/></a></li>
									<li class="thumb m10"><a href="#"><img src="images/end_banner17.jpg" alt="하단배너17"/></a></li>
									<li class="thumb m7"><a href="#"><img src="images/end_banner18.jpg" alt="하단배너18"/></a></li>
									<li class="thumb m10"><a href="#"><img src="images/end_banner19.jpg" alt="하단배너19"/></a></li>
									<li class="thumb m7"><a href="#"><img src="images/end_banner20.jpg" alt="하단배너20"/></a></li>
								</ul>
							</div>
						</div>
					</div>
