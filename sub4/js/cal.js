document.addEventListener("DOMContentLoaded", function() {
        buildCalendar();
		let holyday = document.createElement('p');
		holyday.append('휴관일(정기휴관일)');
    ...
    function prev() {
		...
		holyday.append('휴관일(정기휴관일)');
		holyday.classList.add("holyday");
		$('.hl').append(holyday);   // @param 전월 캘린더 출력 요청
    }
    ...
    function next() {
		...
		holyday.append('휴관일(정기휴관일)');
		holyday.classList.add("holyday");
		$('.hl').append(holyday);    // @param 명월 캘린더 출력 요청
    }
