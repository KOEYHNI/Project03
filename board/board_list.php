...
?>							
				...
				<div id="sub_right">
					...
					<div class="mlib_title2">게시판 > 목록보기</div>
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li> <a href='board_list.php?page=$new_page'><img src='../main/images/btn_pagination_prev2.png' width='8'/></a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
	...
	{
		$new_page = $page+1;	
		echo "<li class='mg5'> <a href='board_list.php?page=$new_page'><img src='../main/images/btn_pagination_next2.png' width='8'/></a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
